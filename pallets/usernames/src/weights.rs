...
//! Autogenerated weights for pallet_usernames
//!
...
/// Weight functions needed for pallet_usernames.
pub trait WeightInfo {
	fn set_username() -> Weight;
}

/// Weights for pallet_usernames using the Substrate node and recommended hardware.
